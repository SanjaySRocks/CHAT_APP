...
import NewDM from './components/new-dm'; // Or the correct path to NewDM component
...
const { setDirectMessagesContacts, directMessageContacts , channels, setChannels } = useAppStore();
useEffect(()=>{
